...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/admin/:resource(users|roles|categories|sous-categories|marques|couleurs|statuts|titres|objets|images|modifications|promesses|temoignages|commissariats|permissions)',
      name: 'admin-resource',
